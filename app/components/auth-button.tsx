...
export default function AuthButton() {
  ...
  return <a href="/api/auth/signin?provider=google" className="rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-bold text-slate-700 shadow-sm hover:border-indigo-300 hover:text-indigo-700">Sign in with Google</a>;
}
